...
export default function Evenements() {
  ...
  const slugify = str =>
    str
      ...
      .replace(/[^\w-]/g, '');         // supprime tout caractère non alphanumérique
  ...
  return (
    <div className="container py-5">
      ...
      {evenements.length === 0 ? (
        ...
        <div className="row">
          {evenements.map(ev => {
            const slug = slugify(ev.titre);
            const imgSrcList = [
              `/images/events/${slug}.jpeg`,
              `/images/events/${slug}.jpg`,
              ...
              <div key={ev.id} className="col-lg-4 col-md-6 mb-4">
                <div className="card h-100 shadow-sm">
                  <img
                    ...
                    onError={e => {
                      attempt++;
                      if (attempt < imgSrcList.length) {
                        e.currentTarget.src = imgSrcList[attempt];
                      } else {
