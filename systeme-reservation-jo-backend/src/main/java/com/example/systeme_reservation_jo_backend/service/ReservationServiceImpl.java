...
import com.example.systeme_reservation_jo_backend.repository.ReservationRepository;
import com.example.systeme_reservation_jo_backend.repository.PaiementRepository;
import com.example.systeme_reservation_jo_backend.repository.BilletRepository;
...
public class ReservationServiceImpl implements ReservationService {
    ...
    public Reservation effectuerPaiement(Long id, ModePaiement modePaiement) {
        ...
        billet.setStatut(com.example.systeme_reservation_jo_backend.model.StatutBillet.VALIDE);
        billet.setType(com.example.systeme_reservation_jo_backend.model.TypeBillet.ADULTE);
