    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
                String email = tokenProvider.getUsernameFromJWT(jwt); // On récupère l'email

                UserDetails userDetails = utilisateurDetailsService.loadUserByUsername(email); // On charge l'utilisateur par email
