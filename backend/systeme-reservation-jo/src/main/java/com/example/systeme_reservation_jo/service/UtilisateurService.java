...
public interface UtilisateurService {
    ...
    Optional<Utilisateur> getUtilisateurById(Long id); // Récupère un utilisateur par son ID
    Utilisateur updateUtilisateur(Long id, Utilisateur utilisateurDetails); // Met à jour un utilisateur
    void deleteUtilisateur(Long id); // Supprime un utilisateur
